...
game = BoatGameEnvironment(state, num_actions=num_actions, _max_episode_timesteps=max_episode_timesteps, manual_input=MANUAL_INPUT)
...
# Create the trainer
trainer = DCTrainer(game=game, npc=npc, curriculum=curriculum)
